...
/**
 * SohController implements the CRUD actions for Soh model.
 */
class SohController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->SOIDH]);
        } else {
    ...
    /**
     * Finds the Soh model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return Soh the loaded model
